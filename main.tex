...
Nesta resolução, traremos sobre o espaço de estados do sistema em questão e o processo para obtê-lo.
\\\\
Sistemas dinâmicos como o da questão podem ser descritos por relações entrada-saida ou por variáveis internas denominadas variáveis de estado. O problema apresentado trata do modelo da bicicleta cinemática muito útil para modelagem e simulação do movimento de veículos. O espaço de estados irá nos fornecer um modelo matemático de como o veículo se move.
\\\\
